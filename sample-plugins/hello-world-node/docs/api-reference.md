# API Reference — Hello-World-Node
...
**Response:**
```json
{ "status": "ok", "service": "hello-world-node", "language": "Node.js / Express" }
```
...
**Response:**
```json
{ "status": "ok", "message": "Hello from Node.js plugin!", "path": "/api/hello", "language": "Node.js", "sdk_version": "0.2.0" }
```
