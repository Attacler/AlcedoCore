...
<template>
    <div class="p-6">
        ...
        <p class="text-gray-600 mb-4">
            Welcome to the <strong>hello-world-node</strong> plugin — a
            Node.js/Express sample plugin demonstrating the full AlcedoCore SDK
            capabilities.
        </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
            <div class="border rounded-lg p-4 bg-blue-50">
                ...
                <p class="text-sm text-blue-600 mt-1">
                    CRUD, TTL, batch operations via <code>alcedo-sdk-node</code>
                </p>
                <a
                    href="/admin#/p/hello-world-node/kv-demo"
            ...
            <div class="border rounded-lg p-4 bg-green-50">
                ...
                <a
                    href="/admin#/p/hello-world-node/settings"
            ...
            <div class="border rounded-lg p-4 bg-purple-50">
                ...
                <a
                    href="/admin#/p/hello-world-node/items"
