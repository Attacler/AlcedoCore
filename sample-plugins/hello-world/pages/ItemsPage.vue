...
function buildFilterPayload() {
    ...
    if (filters.value.description) {
        conditions.push({
            description: { _contains: filters.value.description },
        });
    }
...
async function updateItem() {
    ...
    try {
        ...
        if (!r.ok) {
            const e = await r.json();
            try {
                error.value = JSON.parse(e).error || "Failed to update";
            } catch {
                error.value = e || "Failed to update";
            }
            return;
        }
        editId.value = null;
    ...
    <div class="items-page">
        ...
        <div class="toolbar">
            ...
            <button
                ...
                :class="{
                    'btn-filter-active': showFilters || hasActiveFilters,
                }"
            ...
            <table class="items-table">
                ...
                <tbody>
                                ...
                                <button
                                    :class="
                                        addForm.status === 'processing'
                                            ...
                                            : 'cat-off'
                                    "
                                    @click="addForm.status = 'processing'"
                                >
                                    proc
                                </button>
                                <button
                                    :class="
                                        addForm.status === 'shipped'
                                            ? 'cat-on'
                                            : 'cat-off'
                                    "
                                    @click="addForm.status = 'shipped'"
                                >
                                    ship
                                </button>
                                <button
                                    :class="
                                        addForm.status === 'delivered'
                                            ? 'cat-on'
                                            : 'cat-off'
                                    "
                                    @click="addForm.status = 'delivered'"
                                >
                                    delv
                                </button>
                            </span>
                    ...
                    >
                        ...
                        <td v-if="editId !== item.id" class="cell-muted">
                                    ...
                                    <button
                                        :class="
                                            editForm.status === 'processing'
                                                ...
                                                : 'cat-off'
                                        "
                                        @click="editForm.status = 'processing'"
                                    >
                                        proc
                                    </button>
                                    <button
                                    ...
                                    <button
                                        :class="
                                            editForm.status === 'delivered'
                                                ...
                                                : 'cat-off'
                                        "
                                        @click="editForm.status = 'delivered'"
                                    >
                                        delv
                                    </button>
                                </span>
