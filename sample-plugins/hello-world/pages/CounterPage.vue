...
<template>
  <div class="counter-page">
    ...
    <div class="button-row">
      <button class="btn btn-dec" :disabled="loading" @click="decrement">−</button>
      <button class="btn btn-reset" :disabled="loading" @click="reset">Reset</button>
      <button class="btn btn-inc" :disabled="loading" @click="increment">+</button>
    </div>
    ...
    <p class="footer-link">
      Link to: <a href="/admin#/p/hello-world/index" class="link">Hello</a>
    </p>
  </div>
</template>
