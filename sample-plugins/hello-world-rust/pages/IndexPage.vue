...
<template>
  <div class="p-6">
    ...
    <p class="text-gray-600 mb-4">
      Welcome to the <strong>hello-world-rust</strong> plugin — a Rust/Axum sample plugin
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
      <div class="border rounded-lg p-4 bg-blue-50">
        ...
        <a href="/admin#/p/hello-world-rust/kv-demo" class="text-blue-500 hover:text-blue-700 text-sm">Try it →</a>
      </div>
      <div class="border rounded-lg p-4 bg-green-50">
        ...
        <a href="/admin#/p/hello-world-rust/settings" class="text-green-500 hover:text-green-700 text-sm">View →</a>
      </div>
      <div class="border rounded-lg p-4 bg-purple-50">
        ...
        <a href="/admin#/p/hello-world-rust/items" class="text-purple-500 hover:text-purple-700 text-sm">Browse items →</a>
      </div>
      <div class="border rounded-lg p-4 bg-orange-50">
        ...
        <a href="/admin#/p/hello-world-rust/" class="text-orange-500 hover:text-orange-700 text-sm">API root →</a>
      </div>
    </div>
  </div>
</template>
