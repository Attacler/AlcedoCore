...
<template>
    <div class="p-6">
        ...
        <p class="text-gray-600 mb-4">
            Welcome to the <strong>hello-world-rust</strong> plugin — a
            Rust/Axum sample plugin demonstrating the full AlcedoCore SDK
            capabilities.
        </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
            ...
            <div class="border rounded-lg p-4 bg-green-50">
                ...
                <a
                    href="/admin#/p/hello-world-rust/settings"
            ...
            <div class="border rounded-lg p-4 bg-purple-50">
                ...
                <a
                    href="/admin#/p/hello-world-rust/items"
