...
/// the database.
pub fn validate_fields_for_write(
    keys: &[String],
...
pub fn coerce_value(value: serde_json::Value, field_type: &FieldType) -> serde_json::Value {
    match field_type {
...
pub fn file_ids_from_value(value: &serde_json::Value) -> Vec<String> {
    match value {
