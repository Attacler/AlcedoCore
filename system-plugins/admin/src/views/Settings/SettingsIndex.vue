        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
                <div class="flex items-center gap-3">
                    ...
                    <div
                        class="flex items-center justify-between ml-auto my-auto"
                    >
                        <span
                            class="material-symbols-outlined text-gray-400 group-hover:text-blue-500 transition-colors text-lg"
                            >chevron_right</span
                        >
                    </div>
                </div>
