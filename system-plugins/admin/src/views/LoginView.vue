...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="w-full max-w-md mx-4">
        ...
        <template #content>
          <form @submit.prevent="handleLogin" class="space-y-4">
            ...
            <Transition name="fade">
              <div v-if="authStore.loginError" class="bg-red-50 border border-red-200 text-red-700 rounded-lg p-3 text-sm flex items-center gap-2">
      ...
      <p class="text-center text-xs text-gray-400 mt-6">Alcedo Admin Panel</p>
    </div>
  </div>
</template>
