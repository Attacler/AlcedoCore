...
import type { FilterCondition, FilterGroup, FilterRule, GroupOperator } from '@/types/filters'
import { isFilterRule, createEmptyRule, createEmptyGroup } from '@/types/filters'
...
<template>
  <div
    class="filter-group"
    :class="[depth > 0 ? 'border border-gray-200 rounded-md p-2 sm:p-3 bg-gray-50/50' : '']"
  >
