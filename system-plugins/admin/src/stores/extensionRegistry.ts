...
export const useExtensionRegistryStore = defineStore(
    ...
    () => {
         ...
         */
        const navItemRegistry = reactive(
            new Map<string, NavItemRegistration>(),
        );
        ...
        function getPluginRegistrations(pluginSlug: string): {
            ...
            for (const reg of Object.values(inputWidgetRegistry.value)) {
        ...
        const allNavItems = computed(() =>
            Array.from(navItemRegistry.values()),
        );
        ...
        function getDisplayComponent(
            type: string,
        ): InputWidgetRegistration | ViewTypeRegistration | undefined {
