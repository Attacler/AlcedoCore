...
import { initCoreCommand } from "./commands/init-core.js";
import { initCommand } from "./commands/init.js";
import { deployCommand } from "./commands/deploy.js";
import { addMigrationCommand } from "./commands/add-migration.js";
import { migrateCommand } from "./commands/migrate.js";
import { addEndpointCommand } from "./commands/add-endpoint.js";
import { addPageCommand } from "./commands/add-page.js";
import { addNavItemCommand } from "./commands/add-nav-item.js";
...
const addCommand = new Command("add")
  .description("Generate plugin components (migrations, endpoints, pages, nav-items)");
...
devCommand.addCommand(proxyCommand);
