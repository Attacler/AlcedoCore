CREATE TABLE IF NOT EXISTS plugin_recovery (
...
CREATE INDEX IF NOT EXISTS idx_plugin_recovery_restart_policy ON plugin_recovery(restart_policy);
CREATE INDEX IF NOT EXISTS idx_plugin_recovery_next_restart_at ON plugin_recovery(next_restart_at);
