# DRY Refactoring of plugin-core
...
Eliminate ~1,200 lines of duplicated code across 3 codebases (plugin-core Rust backend, admin Vue frontend, automation plugin) following a risk-ascending, incremental strategy. Each fix is one subagent dispatch, independently verifiable.
...
|----------|---------------|--------------|
| Rust backend (plugin-core) | 3/10 | 6/10 |
